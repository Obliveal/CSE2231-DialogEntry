...
- **Due Date**: 4/5 <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
The component will be represented with Strings and Sequences. This choice is pretty straightforward, as most of the component's functionality is handling strings, and one of the kernel functions returns a sequence.
