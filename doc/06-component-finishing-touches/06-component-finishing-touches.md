...
- **Name**: Ryan Jung <!-- TODO: fill with first and last name (e.g., Brutus Buckeye) and delete this comment -->
- **Dot Number**: jung.876 <!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment -->
- **Due Date**: 4/19 @ 11:59 PM <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
I think this portfolio project was useful in figuring out the process of developing components, and helped me learn about the way components are structured in this course a lot better. However, this feels like a fairly specific part of software development so I can't really say I understand software development as a whole that much more.
<!-- TODO: discuss -->

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

I wouldn't really say the project surfaced any large gaps in my knowledge of software development but it did solidify my understanding of interfaces and components.
<!-- TODO: discuss -->
...
My perspective hasn't really changed. I like working random fun software projects, so I found this project to be enjoyable overall. Being able to come up with your own component was nice.
<!-- TODO: discuss -->
...
I learned a fair amount about markdown formatting (though there's definitely a lot more I don't know about). Other than that, I can't really think of anything that isn't directly a software skill.
<!-- TODO: discuss -->

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.

- Able to write and interpred Markdown formatting
- Able to create software components using interfaces and abstract classes
- Able to pad out bulleted lists
<!-- TODO: discuss -->
...
This project hasn't affected my career trajectory at all. My opinion on the topic I picked is about the same as where I started.
<!-- TODO: discuss -->
...
I have an interest in game development (rough industry right now, I know), so I've been working on small projects in Unity and Godot. I can create and use new software components to help with these projects. Some mentors I could contact include professors in the software track or upperclassmen in the program.
<!-- TODO: discuss -->
