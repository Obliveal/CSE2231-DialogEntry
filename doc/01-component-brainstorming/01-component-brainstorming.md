...
- **Name**: Ryan Jung<!-- TODO: fill with first and last name (e.g., Brutus Buckeye) and dete this comment -->
- **Dot Number**: jung.876<!-- TODO: fill with OSU dot number (e.g., buckeye.17) and delete this comment -->
- **Due Date**: 2/16 @ 11:50 PM<!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
In terms of career goals I think it would be most interesting to work as a developer at a startup as opposed to a larger company. For personal hobbies, I am interested in producing music, game development, coding, and art.
...
- Component Design #1: Music Note
  - **Description**: The purpose of this component is to model a music note in a digital song. It consists of a pitch and duration, and would be implemented further in some kind of song class.
  - **Kernel Methods**:
    - int getPitch(): gets the pitch of the note
    - int getDuration(): gets the duration of the note
    - void setPitch(int pitch): sets the pitch of the note
    - void setDuration(int duration): sets the duration of the note
  - **Secondary Methods**:
    - void transpose(int semitones): transposes the note up or down by the specified number of semitones
    - void changeDuration(double factor): changes the duration of the note by a factor

<!-- TODO: brainstorm a component and delete this comment -->
- Component Design #2: Dialog Entry
  - **Description**: The purpose of this component is to model a dialog entry for use in a video game. Each entry can hold multiple other DialogEntry objects to create a sort of dialog tree.
  - **Kernel Methods**:
    - String getSpeaker(): gets the name of the speaker
    - String getText(): gets the text spoken by the speaker
    - void setSpeaker(String speaker): sets the name of the speaker
    - void setText(String text): sets the text spoken by the speaker
  - **Secondary Methods**:
    - void addResponse(DialogEntry response): adds a response to the dialog entry, forming a conversation tree
    - boolean hasResponse(): checks if the dialog entry has a response

<!-- TODO: brainstorm a component and delete this comment -->
- Component Design #3: Math Function
  - **Description**: The purpose of this component is to model a mathematical function in an object, likely on a BinaryTree.
  - **Kernel Methods**:
    - double evaluate(double x): evaluates the function at a given value of x
    - String getExpression(): gets the mathematical expression representing the function
    - void setExpression(String expression): sets the mathematical expression representing the function, parsing the String into the tree
  - **Secondary Methods**:
    - MathFunction derivative(): computes the derivative of the function
    - MathFunction integral(): computes the indefinite integral of the function
    - double[] roots(): finds the roots of the function
    - double max(double start, double end): finds the maximum value of the function in the given interval
    - double min(double start, double end): finds the minimum value of the function in the given interval
